...
export function PrincipleCard({ principle, isLastAndOdd }: PrincipleCardProps) {
  ...
  return (
    <div
      className={`relative bg-white dark:bg-slate-800/90 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 p-6 pl-10
                 overflow-hidden hover:border-[#0ea5e9]/40 dark:hover:border-[#38bdf8]/40 hover:shadow-[0_20px_40px_-12px_rgba(14,165,233,0.15)] transition-all duration-300
