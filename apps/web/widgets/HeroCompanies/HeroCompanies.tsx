...
export function HeroCompanies({ headline, lead, primaryCta }: HeroCompaniesProps) {
  ...
  return (
    <section className="relative min-h-[400px] md:min-h-[500px] flex items-center overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 w-40 h-40 rounded-full bg-[#0ea5e9]/20 blur-3xl pointer-events-none" />
      ...
      <Container className="relative z-10">
        <div className="max-w-2xl md:max-w-3xl lg:max-w-4xl py-16 md:py-24">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Button href={ROUTES.SERVICES} variant="secondary" size="lg" className="!bg-transparent dark:!bg-transparent border-2 border-white/60 text-white dark:text-white hover:bg-white/20 dark:hover:bg-white/20 backdrop-blur-sm gap-2">
              {t.btn.more}
