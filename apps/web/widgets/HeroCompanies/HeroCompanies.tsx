      ...
      <Container className="relative z-10">
        <div className="max-w-2xl md:max-w-3xl lg:max-w-4xl py-16 md:py-24">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            ...
            <Button href={ROUTES.SERVICES} variant="secondary" size="lg" className="!bg-transparent border-2 border-white/60 text-white hover:bg-white/20 backdrop-blur-sm gap-2">
              Подробнее
